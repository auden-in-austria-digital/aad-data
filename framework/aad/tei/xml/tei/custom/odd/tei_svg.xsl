...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-ptr-ptrAtts-13-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-ref-refAtts-14-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-list-gloss-list-must-have-labels-15-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-relatedItem-targetorcontent1-16-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_svg-l-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-lg-atleast1oflggapl-18-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-lg-abstractModel-structure-l-19-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-quotation-quotationContents-20-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-div-abstractModel-structure-l-23-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-div-abstractModel-structure-p-24-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-link-linkTargets3-25-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-ab-abstractModel-structure-ab-26-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-ab-abstractModel-structure-l-27-->
   ...
   <!--PATTERN schematron-constraint-tei_svg-join-joinTargets3-28-->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-standOff-nested_standOff_should_be_typed-29-->
