...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_its-ptr-ptrAtts-13-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_its-ref-refAtts-14-->
   ...
   <!--PATTERN schematron-constraint-tei_its-list-gloss-list-must-have-labels-15-->
   ...
   <!--PATTERN schematron-constraint-tei_its-relatedItem-targetorcontent1-16-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_its-l-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-tei_its-lg-atleast1oflggapl-18-->
   ...
   <!--PATTERN schematron-constraint-tei_its-lg-abstractModel-structure-l-19-->
   ...
   <!--PATTERN schematron-constraint-tei_its-quotation-quotationContents-20-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_its-div-abstractModel-structure-l-23-->
   ...
   <!--PATTERN schematron-constraint-tei_its-div-abstractModel-structure-p-24-->
