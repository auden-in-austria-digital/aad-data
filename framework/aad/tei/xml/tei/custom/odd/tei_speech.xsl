...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_speech-ptr-ptrAtts-13-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_speech-ref-refAtts-14-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-list-gloss-list-must-have-labels-15-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-relatedItem-targetorcontent1-16-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_speech-l-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-lg-atleast1oflggapl-18-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-lg-abstractModel-structure-l-19-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-quotation-quotationContents-20-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_speech-div-abstractModel-structure-l-23-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-div-abstractModel-structure-p-24-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-shift-shiftNew-25-->


	  <!--RULE -->
   <xsl:template match="tei:shift" priority="1000" mode="M27">
...
remarkable at this point. (@new / warning)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_speech-relation-reforkeyorname-26-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-relation-activemutual-27-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-relation-activepassive-28-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-objectIdentifier-objectIdentifier_minimal-29-->


	  <!--RULE -->
   <xsl:template match="tei:objectIdentifier" priority="1000" mode="M31">
   ...
   <!--PATTERN schematron-constraint-tei_speech-link-linkTargets3-30-->


	  <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M32">
   ...
   <!--PATTERN schematron-constraint-tei_speech-ab-abstractModel-structure-ab-31-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-ab-abstractModel-structure-l-32-->
   ...
   <!--PATTERN schematron-constraint-tei_speech-join-joinTargets3-33-->


	  <!--RULE -->
   <xsl:template match="tei:join" priority="1000" mode="M35">
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_speech-standOff-nested_standOff_should_be_typed-34-->


	  <!--RULE -->
   <xsl:template match="tei:standOff" priority="1000" mode="M36">
