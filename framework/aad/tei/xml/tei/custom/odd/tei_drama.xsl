...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_drama-ptr-ptrAtts-13-->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_drama-ref-refAtts-14-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-list-gloss-list-must-have-labels-15-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-relatedItem-targetorcontent1-16-->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_drama-l-abstractModel-structure-l-17-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-lg-atleast1oflggapl-18-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-lg-abstractModel-structure-l-19-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-quotation-quotationContents-20-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_drama-div-abstractModel-structure-l-23-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-div-abstractModel-structure-p-24-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-link-linkTargets3-25-->


	  <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M27">
   ...
   <!--PATTERN schematron-constraint-tei_drama-ab-abstractModel-structure-ab-26-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-ab-abstractModel-structure-l-27-->
   ...
   <!--PATTERN schematron-constraint-tei_drama-join-joinTargets3-28-->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_drama-standOff-nested_standOff_should_be_typed-29-->


	  <!--RULE -->
   <xsl:template match="tei:standOff" priority="1000" mode="M31">
