...
Child elements of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-dataRef-restrictAttResctrictionName-45-->


	  <!--RULE -->
   <xsl:template match="tei:dataRef" priority="1000" mode="M51">
   ...
   <!--PATTERN schematron-constraint-tei_odds-link-linkTargets3-46-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-ab-abstractModel-structure-ab-47-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-ab-abstractModel-structure-l-48-->
   ...
   <!--PATTERN schematron-constraint-tei_odds-join-joinTargets3-49-->


	  <!--RULE -->
   <xsl:template match="tei:join" priority="1000" mode="M55">
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-standOff-nested_standOff_should_be_typed-50-->


	  <!--RULE -->
   <xsl:template match="tei:standOff" priority="1000" mode="M56">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:value" priority="1000" mode="M57">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:unicodeName" priority="1000" mode="M58">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:localName" priority="1000" mode="M59">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:glyphName" priority="1000" mode="M60">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:charProp" priority="1000" mode="M61">
   ...
   <!--PATTERN -->
	  ...
	  <!--RULE -->
   <xsl:template match="tei:charName" priority="1000" mode="M62">
