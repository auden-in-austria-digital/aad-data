...
plt.scatter(monthly_docs.index, monthly_docs, color='#D4AF37', marker='.')  # plot series, set point markers, gold color
...
plt.scatter(monthly_auden.index - offset, monthly_auden, color='#000080', label='W. H. Auden', marker='.')  # plot Auden documents with offset, navy blue color
plt.scatter(monthly_other.index + offset, monthly_other, color='#FFDB58', label='other', marker='.')  # plot other documents with reverse offset, soft gold color
